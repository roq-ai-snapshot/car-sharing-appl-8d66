...
export const appConfig: AppConfigInterface = {
  ...
  customerAbilities: ['Manage personal info', 'Book a car', 'Provide feedback', 'View company info'],
  ownerAbilities: ['Manage users', 'Manage companies', 'Manage cars', 'Manage bookings'],
  getQuoteUrl: 'https://app.roq.ai/proposal/9122b748-7950-4c2c-88d1-315903d6ee82',
};
